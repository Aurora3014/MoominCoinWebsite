      ...
      <div className={classNames('grid grid-cols-1 gap-y-4', {'md:grid-cols-5': !!profileImageSrc})}>
        {!!profileImageSrc && (
          <div className="col-span-2 flex justify-center">
              <Image alt="about-me-image" className="md:h-full md:w-full h-[80%] w-[80%]  object-cover" src={profileImageSrc} />
          </div>
        )}
        <div className={classNames('col-span-1 flex flex-col justify-center gap-y-6', {'md:col-span-3': !!profileImageSrc})}>
          <div className="flex flex-col  gap-y-5 md:ml-10">
            ...
            <p className="prose prose-sm text-gray-900 sm:prose-base md:text-2xl">{description1}</p>
            <p className="prose prose-sm text-gray-900 sm:prose-base md:text-2xl">{description2}</p>
          </div>
