      ...
      <div className="relative flex h-screen w-full items-center justify-center bg-[#F7DCD3]">
        ...
        <div className='flex justify-center flex-col text-center md:flex-row  items-center absolute z-25 w-full h-full gap-y-10 gap-x-20 max-w-screen-lg'>
            ...
            <div className=''> 
              <div className='flex md:flex-row justify-center flex-col w-full'>
                ...
                <div className='flex flex-row justify-center'>
                  <a className='mx-2  my-3 md:text-xl text-center font-bold text-[#fff] bg-[#c72727] shadow-md shadow-black cursor-pointer p-3 hover:transition-shadow hover:duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#fff] sm:hover:shadow-lg sm:hover:shadow-black '
                    href='/whitepaper.pdf'>
                    WHITEPAPER
                  </a>
                  <a className='mx-2  my-3 w-full md:text-xl text-center font-bold text-[#fff] bg-[#c72727] shadow-md shadow-black cursor-pointer p-3 hover:transition-shadow hover:duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#fff] sm:hover:shadow-lg sm:hover:shadow-black '
          ...
          <div>
            <Image
              alt={`${name}-image`}
              className="md:h-[21rem] md:w-[20rem] w-[380px] "
              // placeholder="blur"
              priority
              src={logoGreenSrc}
            />
